...
local function setupGUI()
    ...
    if InitExclusive then
        ...
        if InitAutos then
            pcall(function()
                InitAutos(AutosCollect, AutosQuest, AutosJack, AutosFavorit, AutosAppraise, AutoAppraise, AutoEnchant, Collect, AutosSection, AuraSection, AutoJetskiSection, FoodSection)
            end)
        end
